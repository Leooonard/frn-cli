...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        Command
            ...
            init_1.default(projectName, !!options.npm, !!options.knr, !!options.taobao, !!options.verbose, !!options.silent, !!options.exist, !!options.redux, !!options.override);
        });
        // Command
